...
public class PasswordTest {
	...
	public void testContainsLowerCase() {
		// boolean containsLowerCase() - returns true iff password contains at least one lower case letter
	...
	public void testSafetyLevel() {
		...
		//                 Password.MEDIUM  (int 2) if password has at least 8 chars,  at least one upper and one lower case letter, and at least one digit ALL EXCEPT SYMBOLS
		//                 Password.WEAK    (int 3) if password has at least 8 chars,  at least one upper and one lower case letter, and at least one digit EITHER CAPS WITH noCAPS OR noCaps with numbers
